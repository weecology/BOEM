...
from ..cast_models import cast_deit_hier 
...
def get_args_parser():
    ...
    parser.add_argument('--data-set', default='BIRD-HIER-SUPERPIXEL', choices=['AIR-HIER-SUPERPIXEL', 'BIRD-HIER-SUPERPIXEL', 'BREEDS-HIER-SUPERPIXEL',
                                                                'INAT21-MINI-HIER-SUPERPIXEL', 'USGS', 'USGS-SUPERPIXEL'],
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if max_accuracy < test_stats["acc1"]: 
            ...
            if args.output_dir:
                ...
                print(f"Saved checkpoint at epoch {epoch} with accuracy {max_accuracy:.1f}%")
