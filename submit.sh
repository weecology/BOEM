...
srun python main.py check_annotations=True active_learning.pool_limit=20000 active_testing.n_images=5 active_learning.n_images=40 debug=False pipeline.gpus=1
