#!/bin/bash
#SBATCH --job-name=meta_off   # A/B run: classification WITHOUT flight metadata
...
#SBATCH --output=/home/b.weinstein/logs/meta_off_%j.out
#SBATCH --error=/home/b.weinstein/logs/meta_off_%j.err
